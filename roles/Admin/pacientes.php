    ...
    <div class="navigation">
      <div class="navArea">
        <ul>
          ...
          <li>
            <a href="#" onmouseenter="changeImage('../../img/pacientes-min.jpg')">
              Pacientes
            </a>
          </li>
          <li>
  ...
  <div class="contenedor-pacientes">
    ...
    <div class="botones">
      ...
      <button type="button" class="boton-ver-pacientes">
        <i class="fas fa-users icon"></i>pacientes
      </button>
    </div>
        ...
        <?php while ($row = $resultado->fetch_assoc()) { ?>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td> <button type="button" class="boton-ver-ficha"><i class="fas fa-eye"></i>
